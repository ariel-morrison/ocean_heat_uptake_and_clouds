...
if __name__=='__main__':
    working_dir, year, latitude, longitude, seaIce_cutoff = sys.argv[1], sys.argv[2], sys.argv[3], sys.argv[4], sys.argv[5]
    df_lon, df = granger_causality(working_dir, year, latitude, longitude, seaIce_cutoff)
